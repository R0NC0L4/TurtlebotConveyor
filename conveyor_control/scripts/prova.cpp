// This program makes conveyor move
#include <ros/ros.h>
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub_fr_w = nh.advertise<std_msgs::Float64>("conveyor/front_right_wheel_velocity_controller/command", 1000);
  ros::Publisher pub_fl_w = nh.advertise<std_msgs::Float64>("conveyor/front_left_wheel_velocity_controller/command", 1000);
  ros::Publisher pub_br_w = nh.advertise<std_msgs::Float64>("conveyor/back_right_wheel_velocity_controller/command", 1000);
  ros::Publisher pub_bl_w = nh.advertise<std_msgs::Float64>("conveyor/back_left_wheel_velocity_controller/command", 1000);
