...
// ROS Node
ros::NodeHandle  nh;
conveyor_description_pkg::conveyor_state mydata;
...
ros::Publisher pub("joint_state", &mydata);
...
void loop()
{ 
  mydata.wheel_lr = dxl.getPresentPosition(1, UNIT_DEGREE);
  mydata.wheel_rr = dxl.getPresentPosition(2, UNIT_DEGREE);
  mydata.wheel_lf = dxl.getPresentPosition(3, UNIT_DEGREE);
  mydata.wheel_rf = dxl.getPresentPosition(4, UNIT_DEGREE);
  mydata.joint_lr = dxl.getPresentPosition(5, UNIT_DEGREE);
  mydata.joint_rr = dxl.getPresentPosition(6, UNIT_DEGREE);
  mydata.joint_lf = dxl.getPresentPosition(7, UNIT_DEGREE);
  mydata.joint_rf = dxl.getPresentPosition(8, UNIT_DEGREE);
